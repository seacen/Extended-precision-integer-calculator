...
main(int argc, char **argv) {
	...
	printf("\n\n\n                               锡昌整数计算器\n\n\n");
	printf("*******************************************************************************\n\n");
	printf("本程序可做任意100位以内整数之间的加、减、乘和乘方运算\n");
	printf("如运算后的结果超过100位，程序会结束运行\n\n");
	printf("...............................................................................\n\n");
	printf("【使用方法】\n\n");
	printf("1.做任意运算时，运算符号左边须为任意一英文小写字母，此字母代表一数字在计算器存储");
	printf("的位置，本计算器可同时存储最多26个数字（a至z）。第一次使用此字母时，请首先用等号分配其一数字（或任意一之前被分配数字的字母）\n\n");
	printf("例如：a=30  d=-3495843   y=a\n\n");
	printf("2.运算符号的选择只有5种：?,=,+,*，^，分别为查看、等于、加、乘和乘方。如须作减法运算，请在运算符号一边输入负数\n\n");
	printf("例如：e=-5   c=6  c+e （结果为1）\n\n"); 
	printf("3.运算符号右边可为任意一100位以内的数字，或任意一之前被分配数字的字母\n\n");
	printf("例如：g=-2348239055347958    g^3\n\n");
	printf("4.运算的结果自动被存入运算符号左边的字母，该字母下原先的数字将被替换\n\n");
	printf("5.如需查看运算结果，请输入上次运算时等号左边的字母，再输入问号，按回车结束\n\n");
	printf("例如：a=30    b=-50     a*b   a?\n\n");
	printf("6.每一行命令（格式：运算符号左边  运算符号  运算符号右边）须以回车结束\n\n\n");
	printf("示例：\n\n\n> a=30\n> b=-5\n> a+b\n> a?\n25\n> b?\n-5\n\n\n> d=-5\n> h=9\n> d*h\n> d?\n-45\n> h?\n9\n\n\n> t=40\n> t^2\n> t?\n1600\n\n\n\n");
	printf("                   锡昌整数计算器    赵锡昌版权所有\n");
	printf("*******************************************************************************\n\n");
	zero_vars(vars);
	print_prompt();
...
/* set the final array to all 0 values */
